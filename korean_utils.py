...
def sentence_segmentation_ko(text):
    """
    将韩语文本分割成句子。
...
def vectorize_tfidf_ko(sentences):
    """
    使用 TF-IDF 将韩语句子向量化。
...
def calculate_similarity_ko(sentence_vectors):
    """
    计算韩语句子向量之间的余弦相似度。
...
def apply_textrank_ko(similarity_matrix, sentences):
    """
